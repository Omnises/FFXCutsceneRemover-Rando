...
static class Transitions
{
    ...
    static readonly GuardsTransition GuardsTransition = new GuardsTransition { ForceLoad = false, Description = "Guards", Suspendable = false, Repeatable = true };
    ...
    public static readonly Dictionary<Func<bool>, Transition> StandardTransitions = new Dictionary<Func<bool>, Transition>()
            ...
            new Transition {FangirlsOrKidsSkip = 3, PositionTidusAfterLoad = true, Target_x = 15.0f, Target_y = -14.960f, Target_z = -8.0f, Target_var1 = 123, Description = "Fangirls"} },
        {
            ...
            new Transition {FangirlsOrKidsSkip = 3, PositionTidusAfterLoad = true, Target_x = 15.0f, Target_y = -14.960f, Target_z = -8.0f, Target_var1 = 123, Description = "Fangirls"} },
        {
            () => { return MemoryWatchers.RoomNumber.Current == 368 && MemoryWatchers.Storyline.Current == 3 && MemoryWatchers.FangirlsOrKidsSkip.Current == 3 && MemoryWatchers.TidusXCoordinate.Current < 5.0f && MemoryWatchers.TidusZCoordinate.Current < 8.0f && MemoryWatchers.TidusZCoordinate.Current > -8.0f; },
            new Transition { RoomNumber = 376, Storyline = 4, SpawnPoint = 0, Description = "Tidus leaves fans"} },
        {
                                        ...
                                        // They leave the submerged ruins
        {
            ...
            new UnderwaterRuinsOutsideTransition {ForceLoad = false, Description = "Underwater Ruins Outside", Suspendable = false, Repeatable = true} },
        {
            ...
            new Transition { ForceLoad = false, PositionTidusAfterLoad = true, Target_x = -184.754f, Target_y = 26.5f, Target_z = -46.699f, Target_rot = -1.821f, Target_var1 = 393, ConsoleOutput = false, Description = "Tidus wakes up in the sea - Reposition"} },
        {
            ...
            new LagoonTransition {ForceLoad = false, Description = "Lagoon", Suspendable = false, Repeatable = true} },
        {
            ...
            new Transition { RoomNumber = 103, Storyline = 164, Description = "Wakka catches up with Tidus in trials"} },
        {
            ...
            new Transition { RoomNumber = 42, Storyline = 170, Description = "Tidus meets Lulu and Kimahri + FMV "} },
        {
                                        ...
                                        // Tidus wakes up again (Party healed at this point)
        {
            ...
            new BrotherhoodTransition { RoomNumber = 69, Storyline = 210, SpawnPoint = 3, TidusWeaponDamageBoost = 5, Description = "Yuna says goodbye to Besaid" } },
        {
            ...
            new Transition { RoomNumber = 67, Storyline = 214, SpawnPoint = 3, Description = "Yuna says goodbye to Besaid again"} },
        {
            ...
            new KimahriTransition {ForceLoad = false, Description = "Kimahri", Suspendable = false, Repeatable = true} },
        {
            () => { return MemoryWatchers.RoomNumber.Current == 21 && MemoryWatchers.Storyline.Current == 216; },
            new Transition {ForceLoad = false, Description = "Post-Kimahri"} },
        {
            () => { return MemoryWatchers.RoomNumber.Current == 19 && MemoryWatchers.Storyline.Current == 218 && MemoryWatchers.State.Current == 0; },
            new Transition { RoomNumber = 301, Storyline = 220, Description = "S.S. Liki departs" } },
        // END OF BESAID
        // START OF SS LIKI
        {
        ...
        // START OF KILIKA
        {
            ...
            new Transition { RoomNumber = 43, Storyline = 294, SpawnPoint = 0, Description = "Undocking in Kilika" } },
        {
            ...
            new Transition { Storyline = 346, SpawnPoint = 1, PositionTidusAfterLoad = true, Target_x = -12.839f, Target_y = 0.0f, Target_z = -5.327f, Target_var1 = 31, Description = "Fayth explanation"} },
        {
            ...
            new Transition { MenuTriggerValue = 0x40080009, ForceLoad = false, Description = "Naming Ifrit"} },
        {
            ...
            new Transition { RoomNumber = 104, Storyline = 490, Description = "Kimahri Yuna's gone"} },
        {
            ...
            new Transition { RoomNumber = 77, Storyline = 492, SpawnPoint = 1, Description = "Lulu explains the situation" } },
                                        // Machina fights
        {
            ...
            new Transition { RoomNumber = 125, Storyline = 583, AurochsPlayer1 = 0, Description = "Aurochs win/lose the game"} },
        {
            ...
            new SahaginTransition {ForceLoad = false, Description = "Pre-Sahagins", Suspendable = false, Repeatable = true} },
        {
            ...
            new Transition { RoomNumber = 89, Storyline = 616, Description = "Wakka joins Yuna"} },
        {
            ...
            new Transition { Storyline = 617, SpawnPoint = 1, FullHeal = true, PositionTidusAfterLoad = true, Target_x = -454.963f, Target_y = 0.0f, Target_z = -321.963f, Target_rot = 0.610f, Target_var1 = 189, Description = "Tidus shouts at Auron"} },
        {
            ...
            new Transition { RoomNumber = 214, Storyline = 995, SpawnPoint = 0, Description = "Entering the Djose trials"} },
        {
            ...
            new Transition { MenuTriggerValue = 0x4008000A, ForceLoad = false, Description = "Naming Ixion"} },
        {
        ...
        {
            () => { return MemoryWatchers.RoomNumber.Current == 161 && MemoryWatchers.Storyline.Current == 1010 && MemoryWatchers.MovementLock.Current == 48 && MemoryWatchers.YCoordinate.Current > 10.0f; },
            new Transition { RoomNumber = 82, Storyline = 1015, SpawnPoint = 2, Description = "Tidus wakes Yuna up"} },
        {
            ...
            new Transition { RoomNumber = 236, Storyline = 1070, SpawnPoint = 0, Description = "Back on the shoopuf"} },
        {
            ...
            new Transition { RoomNumber = 109, Storyline = 1085, SpawnPoint = 0, MoonflowFlag2 = 36, RikkuOutfit = 0, Description = "Reunite with Rikku + FMV"} },
        {
        ...
        {
            () => { return MemoryWatchers.RoomNumber.Current == 219 && MemoryWatchers.Storyline.Current == 1940; },
            new Transition {ForceLoad = false, PositionTidusAfterLoad = true, Target_x = 59.25f, Target_y = 0.0f, Target_z = 65.75f, Target_var1 = 27, Description = "Position Tidus - Summoner Room"} },
        { 
        ...
        {
            () => { return MemoryWatchers.RoomNumber.Current == 194 && MemoryWatchers.Storyline.Current == 2000 && MemoryWatchers.State.Current == 0 && MemoryWatchers.XCoordinate.Current > 300f; },
            new Transition { RoomNumber = 194, Storyline = 2020, SpawnPoint = 1, PositionTidusAfterLoad = true, Target_x = -242.667f, Target_y = 12.514f, Target_z = 398.095f, Target_rot = -1.659f, Target_var1 = 1463, Description = "Zoom in on Bevelle"} },
        { 
        ...
        { 
            ...
            new Transition { MenuTriggerValue = 0x4008000C, ForceLoad = false, Description = "Trials to Bahamut naming"} },
        { 
            ...
            new Transition { RoomNumber = 198, Storyline = 2220, SpawnPoint = 0, Description = "Bahamut to Via Purifico", ViaPurificoPlatform = 1 } },
        //{ () => { return MemoryWatchers.RoomNumber.Current == 226 && MemoryWatchers.Storyline.Current == 2135},
        ...
        //  new Transition { RoomNumber = 198, Storyline = 2220, SpawnPoint = 0, Description = "Bahamut to Via Purifico", ViaPurificoPlatform = 1 } },
        { 
            () => { return MemoryWatchers.RoomNumber.Current == 198 && MemoryWatchers.Storyline.Current == 2220; }, 
        ...
        { 
            ...
            new Transition { Storyline = 2275, SpawnPoint = 2, Description = "Enter Highbridge" } },
        { 
    ...
    public static readonly Dictionary<Func<bool>, Transition> PostBossBattleTransitions = new Dictionary<Func<bool>, Transition>()
    {
        ...
        { 
            () => { return MemoryWatchers.RoomNumber.Current == 45 && MemoryWatchers.Storyline.Current == 346 && MemoryWatchers.State.Current == 1; }, 
            new Transition { RoomNumber = 78, Storyline = 348, SpawnPoint = 0, Description = "Ifrit"} },
        { 
        ...
        { 
            ...
            new Transition { RoomNumber = 121, Storyline = 508, EncounterMapID = 0, EncounterFormationID2 = 0, Description = "Oblitzerator"} },
        { 
        ...
        { 
            ...
            new Transition { RoomNumber = 192, Storyline = 1504, EncounterMapID = 0, EncounterFormationID2 = 0, SpawnPoint = 1, TargetFramerate = 2, Description = "Crawler"} },
        { 
        ...
        { 
            ...
            new Transition { RoomNumber = 129, Storyline = 1715, SpawnPoint = 0, EncounterMapID = 0, EncounterFormationID2 = 0, Description = "Bikanel Zu", PositionTidusAfterLoad = true, Target_x = -20.052f, Target_y = -2.300f, Target_z = -247.011f, Target_rot = -1.570f, Target_var1 = 1819 } },
        { 
